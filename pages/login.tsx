            ...
            <div className="space-y-4">
             <label className="inline-block w-full">
                <input 
                 ...
                 type="email" 
                 placeholder="Email"/>
                 {errors.email && (<p className="p-1 text-[13px] font-inline text-orange-500">Invalid email submission</p>)}
              </label>
             <label className="inline-block w-full">
                <input 
                ...
                {errors.password && (<p className="p-1 text-[13px] font-inline text-orange-500" > Invalid password submission password must contain atleast 6 characters </p>)}
              </label>  
          </div>
          <button onClick={() => setLogin(true)} className="w-full rounded bg-[#e50914] py-3"> Sign in </button>
